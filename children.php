...
<body>
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <ul class="nav flex-column p-0 m-0">
            ...
            <li class="nav-item">
                <a href="children.php" class="nav-link active"><i class="bi bi-people"></i> My Children</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a href="parent_settings.php" class="nav-link"><i class="bi bi-gear"></i> Settings</a>
            </li>
            <li class="nav-item">
