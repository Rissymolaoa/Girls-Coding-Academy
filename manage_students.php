...
<head>
    ...
    <style>
        ...
        /* Loading Screen – White background + centered small logo + rotating ring */
        #loading-screen {
            position: fixed;
            inset: 0;
            z-index: 9999;
...
<div id="loading-screen">
    <div class="logo-ring-container">
        <img 
            ...
            alt="GCA Logo" 
            class="rounded-full"
            onerror="this.src='https://via.placeholder.com/120/7b2cbf/ffffff?text=GCA';"
        />
                        ...
                        <div class="card student-card h-100">
                            <div class="card-body text-center p-4">
                                ...
                                <div class="mt-4 d-flex justify-content-center gap-2">
                                    ...
                                    <button class="action-btn btn btn-outline-danger" onclick="confirmDelete(<?= $s['user_id'] ?>)">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            ...
                                            <button class="btn btn-sm btn-outline-danger" onclick="confirmDelete(<?= $s['user_id'] ?>)"><i class="bi bi-trash"></i></button>
...
<script>
    ...
    // Hide loading screen – more reliable
    ...
    function confirmDelete(userId) {
        Swal.fire({
            ...
            text: "This will permanently remove the student and all related data!",
            icon: 'warning',
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (urlParams.has('success') || <?= json_encode($success_message ?? '') ?>) {
            Swal.fire({
                icon: 'success',
                title: 'Success',
                text: '<?= addslashes($success_message ?: 'Action completed successfully!') ?>',
                timer: 3000,
